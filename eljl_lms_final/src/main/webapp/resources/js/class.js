...
function viewAllReportView(jsonData) {
   ...
   TaskStuList.innerHTML += "<td>" + jsonData[i].stuName +"</td>";
...
function selectStuAnswerView(jsonData) {
   let selectStuAnswer = document.getElementById("TaskStuList");

   for(i=0; i<jsonData.length; i++) {
          
  // selectStuAnswer.innerHTML += "<td>" +jsonData[i].answer + "</td>";
...
function selectStuReportView(jsonData) {
   let selectStuReport = document.getElementById("TaskStuList");

   for(i=0; i<jsonData.length; i++) {
          
   //selectStuReport.innerHTML += "<td>" + jsonData[i].answer +"</td>"; 
...
function viewAllETCView(jsonData) {
   ...
   ETCStuList.innerHTML += "<tr>" + "<td>" +  jsonData[i].stuName + "</td>"; 
...
function selectStuETCView(jsonData) {
   let selectStuETC = document.getElementById("ETCStuList");

   for(i=0; i<jsonData.length; i++) {
          
   selectStuETC.innerText += "<td>" + jsonData[i].answer + "</td>" + "</tr>";
